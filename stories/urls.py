...
from stories.views import(
    HomeView, SingleProductView, ReviewsView, ajax_variant_select_sizes, ajax_variant_select_color
)
...
urlpatterns = [
    ...
    path('ajax_variant_select_color/', ajax_variant_select_color, name='ajax_variant_select_color'),
